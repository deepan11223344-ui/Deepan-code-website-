...
150+ providers, 500+ models (free + paid) with OpenAI-compatible API endpoints.
...
# ============================================================================
# PROVIDER REGISTRY — 150+ providers
# ============================================================================
PROVIDERS = {
    # ========================================================================
    # A: AGGREGATORS / GATEWAYS
    # ========================================================================
    "airforce": {
        "name": "Api.Airforce",
        "url": "https://api.airforce/",
        "api_base": "https://api.airforce/v1",
        "description": "13 free models + image/audio generation",
        "key_env": None,
        "free_tier": True,
        "models": [
            ...
            {"id": "mistral-7b", "name": "Mistral 7B", "provider": "airforce", "context_window": 32768, "description": "Mistral 7B"},
            {"id": "qwen-72b", "name": "Qwen 72B", "provider": "airforce", "context_window": 32768, "description": "Alibaba 72B"},
        ]
    },
    "anyscale": {
        "name": "Anyscale",
        ...
        "models": [
            ...
            {"id": "meta-llama/Meta-Llama-3.1-8B-Instruct", "name": "Llama 3.1 8B", "provider": "anyscale", "context_window": 131072, "description": "Lightweight 8B"},
        ]
    },
    "anyapi": {
        "name": "AnyApi",
        ...
        "models": [
            ...
            {"id": "mistral-7b", "name": "Mistral 7B", "provider": "anyapi", "context_window": 32768, "description": "Fast Mistral"},
        ]
    },
    ...
    "baidu": {
        ...
        "description": "ERNIE models — free tier available",
        ...
        "models": [
            ...
            {"id": "ernie-speed-128k", "name": "ERNIE Speed 128K", "provider": "baidu", "context_window": 131072, "description": "Fast long-context"},
            {"id": "ernie-lite-8k", "name": "ERNIE Lite 8K", "provider": "baidu", "context_window": 8192, "description": "Lightweight model"},
        ]
    },
    "baichuan": {
        "name": "Baichuan AI",
        ...
        "description": "Baichuan models — 5M tokens free on signup",
        ...
        "models": [
            ...
            {"id": "Baichuan3-Turbo-128k", "name": "Baichuan 3 Turbo 128K", "provider": "baichuan", "context_window": 131072, "description": "Long context"},
        ]
    },

    # ========================================================================
    # C: CEREBRAS / CLOUDFLARE / COHERE / CHUTES
    # ========================================================================
    "cerebras": {
        "name": "Cerebras",
        ...
        "models": [
            ...
            {"id": "qwen-2.5-32b", "name": "Qwen 2.5 32B", "provider": "cerebras", "context_window": 32768, "description": "Alibaba Qwen"},
        ]
    },
    "chutes": {
        "name": "Chutes AI",
        ...
        "models": [
            ...
            {"id": "chuteai/ChuteLlama3.1-8B", "name": "Chute Llama 3.1 8B", "provider": "chutes", "context_window": 131072, "description": "Lightweight fine-tuned"},
        ]
    },
    "cloudflare": {
        ...
        "models": [
            ...
            {"id": "@cf/qwen/qwen1.5-14b-chat-awq", "name": "Qwen 1.5 14B", "provider": "cloudflare", "context_window": 8192, "description": "Edge Qwen"},
            {"id": "@cf/meta/llama-2-7b-chat-fp16", "name": "Llama 2 7B", "provider": "cloudflare", "context_window": 4096, "description": "Legacy Llama 2"},
            {"id": "@cf/tinyllama/tinyllama-1.1b-chat-v1.0", "name": "TinyLlama 1.1B", "provider": "cloudflare", "context_window": 2048, "description": "Ultra-lightweight"},
        ]
    },
    "cohere": {
        "name": "Cohere",
        ...
        "models": [
            ...
            {"id": "command-light", "name": "Command Light", "provider": "cohere", "context_window": 8192, "description": "Fast model"},
            {"id": "embed-english-v3.0", "name": "Embed v3", "provider": "cohere", "context_window": 512, "description": "Embedding model"},
            {"id": "north-mini-code", "name": "North Mini Code", "provider": "cohere", "context_window": 256000, "description": "Coding model"},
        ]
    },

    # ========================================================================
    # D: DATABRICKS / DEEPINFRA / DEEPSEEK
    # ========================================================================
    "databricks": {
        ...
        "models": [
            ...
            {"id": "meta-llama/Llama-3.3-70B-Instruct", "name": "Llama 3.3 70B", "provider": "databricks", "context_window": 131072, "description": "Open 70B"},
            {"id": "mistralai/Mistral-7B-Instruct-v0.3", "name": "Mistral 7B", "provider": "databricks", "context_window": 32768, "description": "Mistral 7B"},
        ]
    },
    "deepinfra": {
        "name": "DeepInfra",
        ...
        "models": [
            ...
            {"id": "meta-llama/Meta-Llama-3.1-405B-Instruct", "name": "Llama 3.1 405B", "provider": "deepinfra", "context_window": 131072, "description": "Massive 405B"},
            {"id": "google/gemma-2-9b-it", "name": "Gemma 2 9B", "provider": "deepinfra", "context_window": 8192, "description": "Google Gemma 2"},
        ]
    },
    "deepseek": {
        "name": "DeepSeek",
        ...
        "models": [
            ...
            {"id": "deepseek-v2-lite", "name": "DeepSeek V2 Lite", "provider": "deepseek", "context_window": 32768, "description": "Lightweight V2"},
        ]
    },
    ...
    "experientiallabs": {
        ...
        "description": "Claude Fable models - advanced AI inference",
        "key_env": "EXPERIENTIALLABS_API_KEY",
        "free_tier": False,
        "models": [
            {"id": "claude-fable-5.1", "name": "Claude Fable 5.1", "provider": "experientiallabs", "context_window": 200000, "description": "Latest Claude Fable model"},
            {"id": "claude-fable-5", "name": "Claude Fable 5", "provider": "experientiallabs", "context_window": 200000, "description": "Advanced Claude Fable model"},
        ]
    },
    ...
    "fireworks": {
        ...
        "models": [
            ...
            {"id": "accounts/fireworks/models/mixtral-8x22b-instruct", "name": "Mixtral 8x22B", "provider": "fireworks", "context_window": 65536, "description": "MoE model"},
            {"id": "accounts/fireworks/models/llama-v3p1-8b-instruct", "name": "Llama 3.1 8B", "provider": "fireworks", "context_window": 131072, "description": "Fast 8B"},
        ]
    },

    # ========================================================================
    # G: GITHUB / GOOGLE / GROQ
    # ========================================================================
    "github": {
        "name": "GitHub Models",
        ...
        "models": [
            ...
            {"id": "Phi-3.5-MoE-instruct", "name": "Phi-3.5 MoE", "provider": "github", "context_window": 128000, "description": "Microsoft Phi MoE"},
            {"id": "Meta-Llama-3.1-405B-Instruct", "name": "Llama 3.1 405B", "provider": "github", "context_window": 131072, "description": "Massive Llama"},
        ]
    },
    "google": {
        "name": "Google Gemini",
        ...
        "models": [
            ...
            {"id": "gemini-1.5-pro", "name": "Gemini 1.5 Pro", "provider": "google", "context_window": 2097152, "description": "2M context model"},
            {"id": "gemini-2.0-flash-lite", "name": "Gemini 2.0 Flash Lite", "provider": "google", "context_window": 1048576, "description": "Ultra-lightweight"},
            {"id": "gemma-3-27b-it", "name": "Gemma 3 27B", "provider": "google", "context_window": 131072, "description": "Open Gemma 3"},
            {"id": "gemma-3-12b-it", "name": "Gemma 3 12B", "provider": "google", "context_window": 131072, "description": "Mid-size Gemma"},
            {"id": "gemma-3-4b-it", "name": "Gemma 3 4B", "provider": "google", "context_window": 131072, "description": "Lightweight Gemma"},
            {"id": "gemma-2-27b-it", "name": "Gemma 2 27B", "provider": "google", "context_window": 8192, "description": "Previous gen Gemma"},
            {"id": "gemma-2-9b-it", "name": "Gemma 2 9B", "provider": "google", "context_window": 8192, "description": "Small Gemma"},
        ]
    },
    "groq": {
        "name": "Groq",
        ...
        "models": [
            ...
            {"id": "llama-3.1-70b-versatile", "name": "Llama 3.1 70B", "provider": "groq", "context_window": 131072, "description": "Previous gen 70B"},
            {"id": "llama3-8b-8192", "name": "Llama 3 8B", "provider": "groq", "context_window": 8192, "description": "Legacy Llama 3"},
        ]
    },

    # ========================================================================
    # H: GITHUB COPILOT / H2O / HAIKU / HUGGINGFACE
    # ========================================================================
    "github_copilot": {
        "name": "GitHub Copilot",
        "url": "https://github.com/features/copilot",
        "api_base": "https://api.githubcopilot.com",
        "description": "GitHub Copilot models — requires Copilot subscription or free tier",
        "key_env": "GITHUB_TOKEN",
        "free_tier": True,
        "models": [
            {"id": "gpt-4o", "name": "GPT-4o", "provider": "github_copilot", "context_window": 128000, "description": "OpenAI GPT-4o via Copilot"},
            {"id": "gpt-4o-mini", "name": "GPT-4o Mini", "provider": "github_copilot", "context_window": 128000, "description": "Fast GPT-4o via Copilot"},
            {"id": "o3", "name": "o3", "provider": "github_copilot", "context_window": 200000, "description": "Reasoning model via Copilot"},
            {"id": "o4-mini", "name": "o4 Mini", "provider": "github_copilot", "context_window": 200000, "description": "Fast reasoning via Copilot"},
            {"id": "claude-3.5-sonnet", "name": "Claude 3.5 Sonnet", "provider": "github_copilot", "context_window": 200000, "description": "Anthropic Claude via Copilot"},
            {"id": "claude-3.5-haiku", "name": "Claude 3.5 Haiku", "provider": "github_copilot", "context_window": 200000, "description": "Fast Claude via Copilot"},
            {"id": "gemini-2.0-flash", "name": "Gemini 2.0 Flash", "provider": "github_copilot", "context_window": 1048576, "description": "Google Gemini via Copilot"},
            {"id": "Llama-3.3-70B-Instruct", "name": "Llama 3.3 70B", "provider": "github_copilot", "context_window": 131072, "description": "Meta Llama via Copilot"},
            {"id": "DeepSeek-R1", "name": "DeepSeek R1", "provider": "github_copilot", "context_window": 163840, "description": "Reasoning model via Copilot"},
            {"id": "Phi-4", "name": "Phi-4", "provider": "github_copilot", "context_window": 16384, "description": "Microsoft Phi via Copilot"},
            {"id": "Mistral-Large-2411", "name": "Mistral Large", "provider": "github_copilot", "context_window": 128000, "description": "Mistral via Copilot"},
            {"id": "grok-3", "name": "Grok 3", "provider": "github_copilot", "context_window": 131072, "description": "xAI Grok via Copilot"},
        ]
    },
    "h2o": {
        "name": "H2O.ai",
        "url": "https://h2o.ai/",
        "api_base": "https://api.h2o.ai/v1",
        "description": "Enterprise AI — open-source LLMs",
        "key_env": "H2O_API_KEY",
        "free_tier": True,
        "models": [
            {"id": "h2o-danube-3-8b", "name": "H2O Danube 3 8B", "provider": "h2o", "context_window": 131072, "description": "Streaming LLM"},
            {"id": "h2o-danube-2-8b", "name": "H2O Danube 2 8B", "provider": "h2o", "context_window": 8192, "description": "Previous gen"},
            {"id": "h2o-mistral-7b", "name": "H2O Mistral 7B", "provider": "h2o", "context_window": 32768, "description": "Mistral-based"},
        ]
    },
    "huggingface": {
        "name": "Hugging Face",
        ...
        "models": [
            ...
            {"id": "mistralai/Mistral-7B-Instruct-v0.3", "name": "Mistral 7B", "provider": "huggingface", "context_window": 32768, "description": "Mistral 7B"},
            {"id": "deepseek-ai/DeepSeek-R1", "name": "DeepSeek R1", "provider": "huggingface", "context_window": 163840, "description": "Reasoning model"},
        ]
    },
    ...
    "iflytek": {
        ...
        "models": [
            ...
            {"id": "generalv3", "name": "Spark 3.0", "provider": "iflytek", "context_window": 8192, "description": "Previous gen"},
            {"id": "lite", "name": "Spark Lite", "provider": "iflytek", "context_window": 4096, "description": "Lightweight"},
        ]
    },
    ...
    "ai21": {
        ...
        "models": [
            ...
            {"id": "jamba-instruct", "name": "Jamba Instruct", "provider": "ai21", "context_window": 8192, "description": "Instruction-tuned"},
        ]
    },
    ...
    "kluster": {
        ...
        "models": [
            ...
            {"id": "deepseek-ai/DeepSeek-R1", "name": "DeepSeek R1", "provider": "kluster", "context_window": 163840, "description": "Reasoning model"},
        ]
    },
    "kilo": {
        "name": "Kilo Gateway",
        ...
        "models": [
            ...
            {"id": "deepseek-r1", "name": "DeepSeek R1", "provider": "kilo", "context_window": 163840, "description": "Reasoning model"},
            {"id": "qwen-72b", "name": "Qwen 72B", "provider": "kilo", "context_window": 32768, "description": "Alibaba 72B"},
        ]
    },
    ...
    "llm7": {
        ...
        "models": [
            ...
            {"id": "llama-3.3-70b", "name": "Llama 3.3 70B", "provider": "llm7", "context_window": 131072, "description": "Meta 70B"},
            {"id": "mistral-7b", "name": "Mistral 7B", "provider": "llm7", "context_window": 32768, "description": "Mistral 7B"},
        ]
    },

    # ========================================================================
    # M: MISTRAL / MINIMAX / MOONSHOT / MODELSCOPE / MODAL
    # ========================================================================
    "minimax": {
        "name": "MiniMax",
        ...
        "models": [
            ...
            {"id": "abab6.5-chat", "name": "ABAB 6.5", "provider": "minimax", "context_window": 32768, "description": "Flagship"},
            {"id": "MiniMax-Text-01", "name": "MiniMax Text 01", "provider": "minimax", "context_window": 1000000, "description": "1M context"},
        ]
    },
    "mistral": {
        "name": "Mistral AI",
        ...
        "models": [
            ...
            {"id": "ministral-3b-latest", "name": "Ministral 3B", "provider": "mistral", "context_window": 32768, "description": "Ultra-lightweight"},
            ...
            {"id": "pixtral-large-latest", "name": "Pixtral Large", "provider": "mistral", "context_window": 128000, "description": "Vision model"},
            {"id": "open-mistral-nemo", "name": "Mistral Nemo", "provider": "mistral", "context_window": 128000, "description": "Open model"},
        ]
    },
    "modelscope": {
        "name": "ModelScope",
        ...
        "models": [
            ...
            {"id": "Qwen/Qwen2.5-Coder-32B-Instruct", "name": "Qwen 2.5 Coder 32B", "provider": "modelscope", "context_window": 32768, "description": "Code specialist"},
            {"id": "Qwen/Qwen2.5-72B-Instruct", "name": "Qwen 2.5 72B", "provider": "modelscope", "context_window": 131072, "description": "General model"},
        ]
    },
    "modal": {
        "name": "Modal",
        ...
        "models": [
            ...
            {"id": "meta-llama/Meta-Llama-3.1-8B-Instruct", "name": "Llama 3.1 8B", "provider": "modal", "context_window": 131072, "description": "Lightweight 8B"},
        ]
    },
    "moonshot": {
        ...
        "models": [
            ...
            {"id": "moonshot-v1-auto", "name": "Kimi Auto", "provider": "moonshot", "context_window": 131072, "description": "Auto context"},
        ]
    },

    # ========================================================================
    # N: NEBIUS / NVIDIA / NOVITA
    # ========================================================================
    "nebius": {
        "name": "Nebius AI",
        ...
        "models": [
            ...
            {"id": "Qwen/Qwen3-235B-A22B", "name": "Qwen3 235B", "provider": "nebius", "context_window": 131072, "description": "MoE model"},
            {"id": "meta-llama/Meta-Llama-3.1-405B-Instruct", "name": "Llama 3.1 405B", "provider": "nebius", "context_window": 131072, "description": "Massive 405B"},
        ]
    },
    "nvidia": {
        "name": "NVIDIA NIM",
        ...
        "models": [
            ...
            {"id": "meta/llama-3.3-70b-instruct", "name": "Llama 3.3 70B", "provider": "nvidia", "context_window": 131072, "description": "Standard 70B"},
            {"id": "google/gemma-3-27b-it", "name": "Gemma 3 27B", "provider": "nvidia", "context_window": 131072, "description": "Google Gemma 3"},
        ]
    },
    "novita": {
        "name": "Novita AI",
        ...
        "models": [
            ...
            {"id": "meta-llama/llama-3.1-8b-instruct", "name": "Llama 3.1 8B", "provider": "novita", "context_window": 131072, "description": "Fast 8B"},
            {"id": "qwen/qwen-72b-chat", "name": "Qwen 72B", "provider": "novita", "context_window": 32768, "description": "Alibaba 72B"},
        ]
    },

    # ========================================================================
    # O: OPENAI / OPENCODE / OPENROUTER / OLLAMA / OVHCLOUD
    # ========================================================================
    "openai": {
        "name": "OpenAI",
        ...
        "models": [
            ...
            {"id": "o3-mini", "name": "o3 Mini", "provider": "openai", "context_window": 200000, "description": "Light reasoning"},
            {"id": "gpt-4-turbo", "name": "GPT-4 Turbo", "provider": "openai", "context_window": 128000, "description": "Previous flagship"},
            {"id": "gpt-3.5-turbo", "name": "GPT-3.5 Turbo", "provider": "openai", "context_window": 16385, "description": "Legacy cheap model"},
            {"id": "gpt-4", "name": "GPT-4", "provider": "openai", "context_window": 8192, "description": "Original GPT-4"},
            {"id": "chatgpt-4o-latest", "name": "ChatGPT 4o Latest", "provider": "openai", "context_window": 128000, "description": "ChatGPT latest"},
            {"id": "gpt-4o-2024-11-20", "name": "GPT-4o Nov 2024", "provider": "openai", "context_window": 128000, "description": "Dated GPT-4o"},
        ]
    },
    "opencode": {
        "name": "OpenCode Zen",
    ...
    "openrouter": {
        ...
        "models": [
            ...
            {"id": "meta-llama/llama-4-maverick:free", "name": "Meta Llama 4 Maverick (Free)", "provider": "openrouter", "context_window": 1048576, "description": "Meta's best open model"},
            ...
            {"id": "nousresearch/hermes-3-llama-3.1-405b:free", "name": "Hermes 3 405B (Free)", "provider": "openrouter", "context_window": 131072, "description": "405B fine-tuned"},
            {"id": "microsoft/phi-4-reasoning:free", "name": "Phi-4 Reasoning (Free)", "provider": "openrouter", "context_window": 16384, "description": "Microsoft reasoning"},
        ]
    },
    "openrouter_paid": {
        ...
        "models": [
            ...
            {"id": "anthropic/claude-3.5-haiku", "name": "Claude 3.5 Haiku", "provider": "openrouter", "context_window": 200000, "description": "Fast Claude"},
            {"id": "openai/gpt-4o", "name": "GPT-4o", "provider": "openrouter", "context_window": 128000, "description": "OpenAI flagship"},
            {"id": "openai/o3", "name": "o3", "provider": "openrouter", "context_window": 200000, "description": "Reasoning model"},
            {"id": "google/gemini-2.5-pro", "name": "Gemini 2.5 Pro", "provider": "openrouter", "context_window": 1048576, "description": "Google's best model"},
            {"id": "google/gemini-2.5-flash", "name": "Gemini 2.5 Flash", "provider": "openrouter", "context_window": 1048576, "description": "Fast Gemini"},
            ...
            {"id": "qwen/qwen3-235b-a22b", "name": "Qwen3 235B", "provider": "openrouter", "context_window": 131072, "description": "Alibaba MoE"},
            {"id": "mistralai/mistral-large", "name": "Mistral Large", "provider": "openrouter", "context_window": 128000, "description": "Mistral flagship"},
        ]
    },
    "ollama": {
        "name": "Ollama (Local)",
        ...
        "models": [
            ...
            {"id": "mistral", "name": "Mistral (Local)", "provider": "ollama", "context_window": 32768, "description": "Local Mistral"},
            {"id": "phi3", "name": "Phi-3 (Local)", "provider": "ollama", "context_window": 128000, "description": "Microsoft Phi local"},
            {"id": "codellama", "name": "Code Llama (Local)", "provider": "ollama", "context_window": 16384, "description": "Local code model"},
            {"id": "mixtral", "name": "Mixtral (Local)", "provider": "ollama", "context_window": 32768, "description": "Local MoE"},
            {"id": "command-r", "name": "Command R (Local)", "provider": "ollama", "context_window": 128000, "description": "Local Cohere"},
        ]
    },
    "ovhcloud": {
        "name": "OVHcloud AI",
        ...
        "models": [
            ...
            {"id": "llama-3.1-8b-instruct", "name": "Llama 3.1 8B", "provider": "ovhcloud", "context_window": 131072, "description": "EU-hosted 8B"},
        ]
    },

    # ========================================================================
    # P: PARASAIL / POLLINATIONS
    # ========================================================================
    "parasail": {
        "name": "Parasail",
        ...
        "models": [
            ...
            {"id": "deepseek-ai/DeepSeek-R1", "name": "DeepSeek R1", "provider": "parasail", "context_window": 163840, "description": "Reasoning model"},
        ]
    },
    "pollinations": {
        ...
        "models": [
            ...
            {"id": "deepseek", "name": "Pollinations DeepSeek", "provider": "pollinations", "context_window": 32768, "description": "DeepSeek-like"},
        ]
    },
    ...
    "alibaba": {
        ...
        "models": [
            ...
            {"id": "qwen-long", "name": "Qwen Long", "provider": "alibaba", "context_window": 10000000, "description": "10M context"},
            {"id": "qwen-vl-plus", "name": "Qwen VL Plus", "provider": "alibaba", "context_window": 131072, "description": "Vision model"},
        ]
    },
    ...
    "replicate": {
        ...
        "models": [
            ...
            {"id": "meta/meta-llama-3.1-405b-instruct", "name": "Llama 3.1 405B", "provider": "replicate", "context_window": 131072, "description": "Massive Llama"},
            {"id": "mistralai/mixtral-8x7b-instruct-v0.1", "name": "Mixtral 8x7B", "provider": "replicate", "context_window": 32768, "description": "MoE model"},
        ]
    },

    # ========================================================================
    # S: SAMBANOVA / SCALEWAY / SILICONFLOW / STEPFUN
    # ========================================================================
    "sambanova": {
        "name": "SambaNova",
        ...
        "models": [
            ...
            {"id": "Meta-Llama-3.1-8B-Instruct", "name": "Llama 3.1 8B", "provider": "sambanova", "context_window": 131072, "description": "Lightweight 8B"},
        ]
    },
    "scaleway": {
        "name": "Scaleway",
        ...
        "models": [
            ...
            {"id": "meta/llama-3.1-8b-instruct", "name": "Llama 3.1 8B", "provider": "scaleway", "context_window": 131072, "description": "EU-hosted 8B"},
        ]
    },
    "siliconflow": {
        "name": "SiliconFlow",
        ...
        "models": [
            ...
            {"id": "Qwen/Qwen2.5-7B-Instruct", "name": "Qwen 2.5 7B", "provider": "siliconflow", "context_window": 32768, "description": "Lightweight Qwen"},
            {"id": "THUDM/glm-4-9b-chat", "name": "GLM-4 9B", "provider": "siliconflow", "context_window": 128000, "description": "Zhipu GLM"},
        ]
    },
    "stepfun": {
        "name": "StepFun",
        ...
        "models": [
            ...
            {"id": "step-1-128k", "name": "Step 1 128K", "provider": "stepfun", "context_window": 131072, "description": "Extra long context"},
            {"id": "step-2-16k", "name": "Step 2 16K", "provider": "stepfun", "context_window": 16384, "description": "Next gen"},
        ]
    },

    # ========================================================================
    # T: TENCENT / TOGETHER / TOKENROUTER
    # ========================================================================
    "tencent": {
        ...
        "models": [
            ...
            {"id": "hunyuan-pro", "name": "Hunyuan Pro", "provider": "tencent", "context_window": 32768, "description": "Flagship model"},
            {"id": "hunyuan-turbo", "name": "Hunyuan Turbo", "provider": "tencent", "context_window": 32768, "description": "Fast model"},
        ]
    },
    "together": {
        "name": "Together AI",
        ...
        "models": [
            ...
            {"id": "meta-llama/Meta-Llama-3.1-405B-Instruct-Turbo", "name": "Llama 3.1 405B Turbo", "provider": "together", "context_window": 131072, "description": "Massive 405B"},
            {"id": "meta-llama/Meta-Llama-3.1-8B-Instruct-Turbo", "name": "Llama 3.1 8B Turbo", "provider": "together", "context_window": 131072, "description": "Fast 8B"},
            {"id": "databricks/dbrx-instruct", "name": "DBRX Instruct", "provider": "together", "context_window": 32768, "description": "Databricks model"},
        ]
    },
    "tokenrouter": {
        "name": "TokenRouter",
        "url": "https://tokenrouter.ai/",
        "api_base": "https://api.tokenrouter.ai/v1",
        "description": "OpenAI-compatible multi-provider token router",
        "key_env": "TOKENROUTER_API_KEY",
        "free_tier": False,
        "models": [
            {"id": "auto", "name": "TokenRouter Auto", "provider": "tokenrouter", "context_window": 128000, "description": "Provider-selected routing"},
        ]
    },

    # ========================================================================
    # V: VOLCENGINE / VLLM / VENICE
    # ========================================================================
    "volcengine": {
        ...
        "models": [
            ...
            {"id": "doubao-pro-32k", "name": "Doubao Pro 32K", "provider": "volcengine", "context_window": 32768, "description": "Previous gen pro"},
        ]
    },
    "vllm": {
        "name": "vLLM (Local)",
    ...
    "venice": {
        ...
        "free_tier": True,
        "models": [
            {"id": "llama-3.3-70b", "name": "Llama 3.3 70B", "provider": "venice", "context_window": 131072, "description": "Uncensored 70B"},
            {"id": "deepseek-r1", "name": "DeepSeek R1", "provider": "venice", "context_window": 163840, "description": "Reasoning model"},
            {"id": "mistral-7b", "name": "Mistral 7B", "provider": "venice", "context_window": 32768, "description": "Fast Mistral"},
        ]
    },
    ...
    "xai": {
        ...
        "models": [
            ...
            {"id": "grok-2-mini", "name": "Grok 2 Mini", "provider": "xai", "context_window": 131072, "description": "Lightweight Grok"},
        ]
    },
    ...
    "zhipu": {
        ...
        "models": [
            ...
            {"id": "glm-4-flashx", "name": "GLM-4 FlashX", "provider": "zhipu", "context_window": 128000, "description": "Enhanced Flash"},
            {"id": "glm-4-air", "name": "GLM-4 Air", "provider": "zhipu", "context_window": 128000, "description": "Balanced model"},
            {"id": "glm-4-airx", "name": "GLM-4 AirX", "provider": "zhipu", "context_window": 8192, "description": "Fast Air model"},
            {"id": "glm-4-long", "name": "GLM-4 Long", "provider": "zhipu", "context_window": 1000000, "description": "1M context"},
            {"id": "glm-4-plus", "name": "GLM-4 Plus", "provider": "zhipu", "context_window": 128000, "description": "Enhanced model"},
        ]
    },
